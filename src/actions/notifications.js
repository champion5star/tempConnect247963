export default {
  ...
  MARK_READ_ALL_NOTIFICATIONS_REQUEST: 'MARK_READ_ALL_NOTIFICATIONS_REQUEST',
  MARK_READ_ALL_NOTIFICATIONS_SUCCESS: 'MARK_READ_ALL_NOTIFICATIONS_SUCCESS',
  MARK_READ_ALL_NOTIFICATIONS_FAILURE: 'MARK_READ_ALL_NOTIFICATIONS_FAILURE',

  REMOVE_ALL_NOTIFICATIONS: 'REMOVE_ALL_NOTIFICATIONS',
  REMOVE_ALL_NOTIFICATIONS_REQUEST: 'REMOVE_ALL_NOTIFICATIONS_REQUEST',
  REMOVE_ALL_NOTIFICATIONS_SUCCESS: 'REMOVE_ALL_NOTIFICATIONS_SUCCESS',
  REMOVE_ALL_NOTIFICATIONS_FAILURE: 'REMOVE_ALL_NOTIFICATIONS_FAILURE',
